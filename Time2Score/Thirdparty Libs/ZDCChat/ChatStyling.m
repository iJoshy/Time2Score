...
#define greenColor [UIColor colorWithRed:92.0/255.0 green:147.0/255.0 blue:0.0/255.0 alpha:1]
...
+ (void) applyStyling
{
    ...
    [[ZDCChatOverlay appearance] setMessageCountColor:greenColor];
    [[ZDCChatOverlay appearance] setTypingIndicatorColor:greenColor];
    [[ZDCChatOverlay appearance] setTypingIndicatorHighlightColor:greenColor];
    ...
    [[ZDCLoadingView appearance] setLoadingLabelTextColor:greenColor];
    ...
    [[ZDCVisitorChatCell appearance] setBubbleBorderColor:greenColor];
    [[ZDCVisitorChatCell appearance] setBubbleColor:greenColor];
