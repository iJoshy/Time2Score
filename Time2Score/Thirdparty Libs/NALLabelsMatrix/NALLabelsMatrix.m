...
- (void)addRecord: (NSArray*)record {
    ...
    for(uint i=0; i<record.count; i++){
        ...
        [col1.layer setBorderColor:[[UIColor lightGrayColor] CGColor]];
        [col1.layer setBorderWidth:0.5];
		col1.font = [UIFont fontWithName:@"Helvetica" size:9.0];
		col1.frame = rect;
        ...
        if(self->numRows % 2 == 0)
        {
            ...
            col1.textColor = [UIColor redColor];
        }
        else
        {
            col1.backgroundColor = [UIColor redColor];
