...
-(void)setUpView
{
    ...
    txt3view.layer.sublayerTransform = CATransform3DMakeTranslation(20.0f, 0.0f, 0.0f);
...
-(void)getProfile
{
    txtview.text = [[NSUserDefaults standardUserDefaults] stringForKey:@"FIRSTNAME"];
    txt2view.text = [[NSUserDefaults standardUserDefaults] stringForKey:@"LASTNAME"];
    txt3view.text = [[NSUserDefaults standardUserDefaults] stringForKey:@"EMAIL"];
}
...
-(void)callService
{
    ...
    NSString *firstname = txtview.text;
    NSString *lastname = txt2view.text;
    NSString *email = txt3view.text;
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^
       {
           ...
           NSDictionary *response = [ws profile:token :firstname :lastname :email];
